...
import { IMappingConfig as config, IMappingConfigItem as configItem, EMappingType as mappingType } from './models/IMappingConfig'
...
export const EMappingType = mappingType